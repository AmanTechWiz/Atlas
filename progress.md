...
- 2026-06-04 MODIFIED `progress.md` — top-of-file "How an Incoming Agent Should Start" updated to point at agents.md Section 0.5 and to mention rule #0a. Added three new DEVIATION entries to record the rule #0a addition, the Section 0.5 move, and the new reminder at the top of the file.

---

## How an Incoming Agent Should Start
1. Read `agents.md` (master plan, immutable). Start at **Section 0.5** ("How an Incoming Agent Should Start") — it now lives at the top of that file.
...
6. **US 1 is done.** Per rule #0 (added 2026-06-04), ask the user which official US to build next BEFORE writing any code. Per rule #0a, after you finish a US, end your message with `US(x) completed` and **wait** for the user to reply `ok let's move to next us` before updating this file.
